  ...
  return (
    <div >
      <div className=" container px-5 py-1  mx-auto">
        {/* Breadcrumb */}
        <div className="flex mx-auto lg:w-4/5 mb-4 mt-4" aria-label="Breadcrumb">
          <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            <li className="inline-flex items-center">
              <Link to={"/"} className="inline-flex items-center text-sm font-medium text-gray-700 hover:text-cyan-600 ">
            ...
            <li>
              <div className="flex items-center">
                ...
                <Link to={"/products/1"} className="ms-1 text-sm font-medium text-gray-700 hover:text-cyan-600 ">Products</Link>
              </div>
            </li>
            <li>
              <div className="flex items-center">
                ...
                <Link to={`/search/${product.type.detail}/1`} className="ms-1 text-sm font-medium text-gray-700 hover:text-cyan-600 ">{product.type.detail}</Link>
              </div>
            </li>
            <li aria-current="page">
              <div className="flex items-center">
                ...
                <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2">{product.name}</span>
              </div>
            </li>
          </ol>
        </div>
